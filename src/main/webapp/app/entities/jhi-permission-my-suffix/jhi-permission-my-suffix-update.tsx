    ...
    return (
      <div>
        <Row className="justify-content-center">
          <Col md="8">
            <h2 id="departmentSecurityApp.jhiPermission.home.createOrEditLabel">
              <Translate contentKey="departmentSecurityApp.jhiPermission.home.createOrEditLabel">Create or edit a JhiPermission</Translate>
            </h2>
          </Col>
        </Row>
        <Row className="justify-content-center">
